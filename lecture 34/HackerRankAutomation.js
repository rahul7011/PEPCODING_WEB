...
async function HackerRank() {
  ...
  //login procedure
  await page.keyboard.type("kisil21838@smuvaj.com", { delay: 100 });
  await page.keyboard.press("Tab");
  await page.keyboard.type("temp@1234", { delay: 100 });
  ...
  //   await page.keyboard.press("Tab");
  //   let name="T";
  //   await page.keyboard.type(name, { delay: 500 });
  //   await page.keyboard.press("Tab");
  //   let desc="This is the description ";
  //   await page.keyboard.type(desc, { delay: 500 });
  //   await page.keyboard.press("Tab");
  //   await page.keyboard.press("Tab");
  //   let pStat="This is the Problem Statement ";
  //   await page.keyboard.type(pStat, { delay: 100 });
  //   await page.keyboard.press("Tab");
  //   await page.keyboard.press("Tab");
  //   let iFormat="This is the Input Format ";
  //   await page.keyboard.type(iFormat, { delay: 100 });
  //   await page.keyboard.press("Tab");
  //   await page.keyboard.press("Tab");
  //   let cons="This is the Constraint ";
  //   await page.keyboard.type(cons, { delay: 100 });
  //   await page.keyboard.press("Tab");
  //   await page.keyboard.press("Tab");
  //   let oFormat="This is the Output Format ";
  //   await page.keyboard.type(oFormat, { delay: 100 });
  //   await page.keyboard.press("Tab");
}
